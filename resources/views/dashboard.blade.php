            ...
            <div class="relative h-full text-white p-8 min-h-125 flex flex-col justify-between">
                <div class="flex justify-center items-start">
                    <div class="backdrop-blur-md rounded-3xl p-5">
                        <p class="text-2xl font-semibold text-center">Friday</p>
                        <p class="text-xl opacity-90 mt-1 text-center">26 January 2024</p>
                ...
                <div class="text-center">
                    ...
                    <h1 class="text-8xl font-bold leading-none">25°C</h1>
                    <p class="text-2xl mt-4 font-light">Sunny</p>
                </div>
                <div></div>
            </div>
        </x-card>
        <x-card class="flex flex-col gap-6">
            <div class="space-y-4">
                <div class="flex justify-between items-center">
                    <span class="text-slate-400 text-sm font-medium uppercase tracking-wide">Participation</span>
                ...
                <div class="flex justify-between items-center">
                    ...
                    <span class="text-white text-xl font-bold">34%</span>
                </div>
                <div class="flex justify-between items-center">
                    <span class="text-slate-400 text-sm font-medium uppercase tracking-wide">Wind Speed</span>
                    <span class="text-white text-xl font-bold">6 km/h</span>
                </div>
            </div>
            ...
            <button class="w-full bg-blue-600 hover:bg-blue-700 text-white font-semibold py-3.5 px-4 rounded-xl transition-colors duration-200 shadow-lg">
                Search Location
            </button>
        </x-card>
    </div>
